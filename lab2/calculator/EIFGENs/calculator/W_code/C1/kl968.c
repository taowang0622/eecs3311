...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 967, Current, 0, 0, 13461);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(967, Current, 13461);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	tr2 = RTMS_EX_H("",0,0);
	ur1 = tr2;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(5908, Dtype(tr1)))(tr1, ur1x);
	RTNHOOK(1,1);
