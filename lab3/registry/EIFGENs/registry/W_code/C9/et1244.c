...
extern void F1244_12772(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1244_12773(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1244_12774(EIF_REFERENCE);
...
/* {ETF_TUPLE_ARG}.make */
void F1244_12772 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1243, Current, 0, 1, 18994);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1243, Current, 18994);
	{
	...
	*(EIF_REFERENCE *)(Current + RTWA(10512, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10533, 0xF8000107, 0); /* value */
	RTAR(Current, arg1);
...
/* {ETF_TUPLE_ARG}.value */
EIF_TYPED_VALUE F1244_12773 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {ETF_TUPLE_ARG}.out */
EIF_TYPED_VALUE F1244_12774 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1243, Current, 1, 0, 18996);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1243, Current, 18996);
	RTIV(Current, RTAL);
	RTHOOK(1);
