...
extern EIF_TYPED_VALUE F958_7078(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F958_7082(EIF_REFERENCE, EIF_TYPED_VALUE);
...
RTOID (F958_7078)
EIF_TYPED_VALUE F958_7078 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_BOOLEAN)
	...
	RTEAA(l_feature_name, 957, Current, 3, 0, 13351);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ur1 = tr1;
	loc2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4917, dtype))(Current, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTHOOK(2);
	tb1 = '\0';
	...
	if (tb1) {
		...
		ur1 = tr1;
		loc3 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4917, dtype))(Current, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTHOOK(6);
		tb1 = '\0';
...
#define Result RTOTRB(EIF_BOOLEAN)
	...
	RTEAA(l_feature_name, 957, Current, 2, 0, 13352);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRB(EIF_BOOLEAN)
	...
	RTEAA(l_feature_name, 957, Current, 1, 0, 13353);
	RTSA(Dtype(Current));
	RTSC;
...
#define up2 up2x.it_p
	...
	Result = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4918, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(1,1);
...
EIF_TYPED_VALUE F958_7082 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 957, Current, 1, 1, 13355);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
{
	GTCX
	RTOTS (7078,F958_7078)
	RTOTS (7079,F958_7079)
	RTOTS (7080,F958_7080)
	RTOTS (7083,F958_7083)
}
