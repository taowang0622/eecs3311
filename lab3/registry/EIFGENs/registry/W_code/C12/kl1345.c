...
extern EIF_TYPED_VALUE F1345_14149(EIF_REFERENCE);
...
RTOID (F1345_14149)
EIF_TYPED_VALUE F1345_14149 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1344, Current, 0, 0, 20867);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1344, Current, 20867);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
