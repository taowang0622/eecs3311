...
extern EIF_TYPED_VALUE F2021_1934(EIF_REFERENCE);
...
EIF_TYPED_VALUE F2021_1934 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2020, Current, 0, 0, 19923);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2020, Current, 19923);
	RTIV(Current, RTAL);
	RTHOOK(1);
