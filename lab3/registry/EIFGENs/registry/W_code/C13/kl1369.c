...
extern EIF_TYPED_VALUE F1369_14333(EIF_REFERENCE);
...
RTOID (F1369_14333)
EIF_TYPED_VALUE F1369_14333 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1368, Current, 0, 0, 21000);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1368, Current, 21000);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
