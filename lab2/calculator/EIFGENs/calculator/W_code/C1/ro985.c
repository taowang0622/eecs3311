...
extern void F985_7398(EIF_REFERENCE);
...
/* {ROOT}.make */
void F985_7398 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 984, Current, 2, 0, 13658);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if ((EIF_BOOLEAN) !tb1) {
		...
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(5245, Dtype(tr1)))(tr1);
		RTNHOOK(2,1);
		ur1 = RTCCL(tr1);
