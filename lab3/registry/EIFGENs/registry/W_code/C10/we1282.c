...
extern EIF_TYPED_VALUE F1282_13485(EIF_REFERENCE);
...
RTOID (F1282_13485)
EIF_TYPED_VALUE F1282_13485 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1281, Current, 0, 0, 19692);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1281, Current, 19692);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
