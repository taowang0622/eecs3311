...
extern void F1858_22366(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1858_22367(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1858_22368(EIF_REFERENCE);
...
void F1858_22366 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1857, Current, 0, 1, 28398);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1857, Current, 28398);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(18581, dtype)) = (EIF_INTEGER_32) arg1;
	RTHOOK(3);
...
void F1858_22367 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1857, Current, 1, 1, 28399);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1857, Current, 28399);
	RTCC(arg1, 1857, l_feature_name, 1, eif_new_type(228, 0x01), 0x01);
	RTIV(Current, RTAL);
...
void F1858_22368 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1857, Current, 1, 0, 28400);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1857, Current, 28400);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
