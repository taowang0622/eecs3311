...
extern void F970_8731(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F970_8731 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTCC(arg1, 969, l_feature_name, 1, eif_new_type(986, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6567, 0xF80003DA, 0); /* guid */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(6567, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
		RTCT("set", EX_POST);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 969, Current, 2, 0, 15006);
	RTSA(Dtype(Current));
	RTSC;
	...
	for (;;) {
		...
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6567, Dtype(Current)))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		if (RTEQ(tr2, tr1)) {
			RTHOOK(6);
