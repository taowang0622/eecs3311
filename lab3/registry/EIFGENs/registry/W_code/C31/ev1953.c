...
extern void F1953_24786(EIF_REFERENCE);
extern void F1953_24787(EIF_REFERENCE);
extern void F1953_24788(EIF_REFERENCE);
extern void F1953_24789(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1953_24790(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1953_24791(EIF_REFERENCE);
extern void F1953_24792(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1953_24793_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1953_24793(EIF_REFERENCE);
...
void F1953_24786 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1952, Current, 0, 0, 30812);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1952, Current, 30812);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(15570, 1951))(Current);
	RTHOOK(2);
...
void F1953_24787 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1952, Current, 2, 0, 30813);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1952, Current, 30813);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	...
	if (tb1) {
		...
		if (EIF_TEST(loc1)) {
			...
			*(EIF_INTEGER_32 *)(Current + RTWA(19734, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) (((EIF_INTEGER_32) 20L) + (EIF_INTEGER_32) (ti4_1 / ((EIF_INTEGER_32) 2L)));
		} else {
			RTHOOK(4);
			...
			if (EIF_TEST(loc2)) {
				RTHOOK(5);
				RTDBGAA(Current, dtype, 19734, 0x10000000, 1); /* extra_width */
				ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(17681, "height", loc2))(loc2)).it_i4);
				*(EIF_INTEGER_32 *)(Current + RTWA(19734, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) (((EIF_INTEGER_32) 20L) + (EIF_INTEGER_32) (ti4_1 / ((EIF_INTEGER_32) 2L)));
			}
		}
	}
	RTHOOK(6);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(19349, 1951))(Current);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(7);
	RTDBGLE;
...
void F1953_24788 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1952, Current, 0, 0, 30814);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1952, Current, 30814);
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(3);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(16143, 1951))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
void F1953_24789 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1952, Current, 0, 0, 30815);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1952, Current, 30815);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_selectable", EX_PRE);
...
body:;
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(7454, 1020))(Current, up1x, ui4_1x, up2x, up3x);
	RTHOOK(3);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(16145, 1951))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
EIF_TYPED_VALUE F1953_24790 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1952, Current, 0, 0, 30816);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1952, Current, 30816);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1953_24791 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1952, Current, 0, 0, 30817);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1952, Current, 30817);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
...
void F1953_24792 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1952, Current, 0, 1, 30818);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1952, Current, 30818);
	RTCC(arg1, 1952, l_feature_name, 1, eif_new_type(1558, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	tr1 = RTCCL(tr2);
	*(EIF_REFERENCE *)(Current + RTWA(19351, dtype)) = RTRV(RTWCT(19351, dtype, Dftype(Current)), tr1);
	RTAR(Current, tr1);
	RTHOOK(3);
...
static EIF_TYPED_VALUE F1953_24793_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1952, Current, 0, 0, 30819);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1952, Current, 30819);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1953_24793 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15575, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1953_24793_body (Current)).it_r;
