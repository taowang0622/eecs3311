...
extern EIF_TYPED_VALUE F1625_18362(EIF_REFERENCE);
extern void F1625_18363(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1625_18362 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1625_18363 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1624, Current, 0, 0, 25101);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1624, Current, 25101);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14627, 0xF80006CB, 0); /* implementation */
