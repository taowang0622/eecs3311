...
extern EIF_TYPED_VALUE F1798_20536(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1798_20536 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1797, Current, 0, 0, 26642);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1797, Current, 26642);
	RTIV(Current, RTAL);
	RTHOOK(1);
