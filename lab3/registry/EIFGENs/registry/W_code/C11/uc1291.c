...
extern EIF_TYPED_VALUE F1291_13654(EIF_REFERENCE);
...
RTOID (F1291_13654)
EIF_TYPED_VALUE F1291_13654 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1290, Current, 0, 0, 20002);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1290, Current, 20002);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
