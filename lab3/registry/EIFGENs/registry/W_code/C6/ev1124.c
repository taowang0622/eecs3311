...
static EIF_TYPED_VALUE F1124_11173_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1124_11173(EIF_REFERENCE);
static EIF_TYPED_VALUE F1124_11174_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1124_11174(EIF_REFERENCE);
static EIF_TYPED_VALUE F1124_11175_body(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1123, Current, 1, 0, 17470);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1123, Current, 17470);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 9004, 0xF8000534, 0); /* caret_move_actions_internal */
		RTAR(Current, Result);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1123, Current, 1, 0, 17471);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1123, Current, 17471);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 9005, 0xF800053B, 0); /* selection_change_actions_internal */
		RTAR(Current, Result);
		*(EIF_REFERENCE *)(Current + RTWA(9005, dtype)) = (EIF_REFERENCE) RTCCL(Result);
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
		RTCT("not_void", EX_POST);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1123, Current, 1, 0, 17472);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1123, Current, 17472);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 9006, 0xF8000534, 0); /* file_access_actions_internal */
		RTAR(Current, Result);
		*(EIF_REFERENCE *)(Current + RTWA(9006, dtype)) = (EIF_REFERENCE) RTCCL(Result);
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
		RTCT("not_void", EX_POST);
...
static EIF_TYPED_VALUE F1124_11173_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1123, Current, 0, 0, 17473);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1123, Current, 17473);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1124_11173 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9004, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1124_11173_body (Current)).it_r;
...
static EIF_TYPED_VALUE F1124_11174_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1123, Current, 0, 0, 17474);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1123, Current, 17474);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1124_11174 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9005, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1124_11174_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(9005,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
...
static EIF_TYPED_VALUE F1124_11175_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1123, Current, 0, 0, 17475);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1123, Current, 17475);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1124_11175 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9006, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1124_11175_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(9006,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
