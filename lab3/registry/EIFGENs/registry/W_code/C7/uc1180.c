...
extern EIF_TYPED_VALUE F1180_11936(EIF_REFERENCE);
...
RTOID (F1180_11936)
EIF_TYPED_VALUE F1180_11936 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1179, Current, 0, 0, 18210);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1179, Current, 18210);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
