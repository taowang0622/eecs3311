...
extern EIF_TYPED_VALUE F2044_1934(EIF_REFERENCE);
...
EIF_TYPED_VALUE F2044_1934 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2043, Current, 0, 0, 31321);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2043, Current, 31321);
	RTIV(Current, RTAL);
	RTHOOK(1);
