...
static const EIF_TYPE_INDEX egt_13_963 [] = {0xFF01,1122,0xFF01,231,0xFFFF};
static const EIF_TYPE_INDEX egt_14_963 [] = {0xFF01,1120,190,0xFFFF};
static const EIF_TYPE_INDEX egt_15_963 [] = {0xFF01,231,0xFFFF};
...
static const struct desc_info desc_963[] = {
	...
	{EIF_GENERIC(egt_13_963), 13437, 0},
	{EIF_GENERIC(egt_14_963), 13438, 8},
	{EIF_GENERIC(egt_15_963), 13439, 16},
	{EIF_NON_GENERIC(0x017D /*190*/), 13440, 28},
	{EIF_NON_GENERIC(0x0195 /*202*/), 13441, 24},
	{EIF_GENERIC(egt_16_963), 13442, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0195 /*202*/), 13443, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x017D /*190*/), 13444, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 13445, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x017D /*190*/), 15842, 0xFFFFFFFF},
};
void Init963(void)
{
	IDSC(desc_963, 0, 962);
	IDSC(desc_963 + 1, 1, 962);
	IDSC(desc_963 + 32, 357, 962);
}
