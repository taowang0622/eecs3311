...
extern EIF_TYPED_VALUE F1616_18321(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1616_18322(EIF_REFERENCE);
extern void F1616_18323(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1616_18321 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1615, Current, 0, 0, 25061);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1615, Current, 25061);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(14632, 1609))(Current)).it_b);
	if (tb2) {
...
EIF_TYPED_VALUE F1616_18322 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1616_18323 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1615, Current, 0, 0, 25063);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1615, Current, 25063);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14627, 0xF80006C4, 0); /* implementation */
