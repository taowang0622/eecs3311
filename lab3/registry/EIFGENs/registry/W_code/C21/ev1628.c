...
extern EIF_TYPED_VALUE F1628_18377(EIF_REFERENCE);
extern void F1628_18378(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1628_18377 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1628_18378 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1627, Current, 0, 0, 25116);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1627, Current, 25116);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14627, 0xF80006D6, 0); /* implementation */
