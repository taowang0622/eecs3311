...
extern void F1940_24552(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1940_24553(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1940_24554(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1940_24555(EIF_REFERENCE);
extern void F1940_24556(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1940_24557(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1940_24558_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1940_24558(EIF_REFERENCE);
...
void F1940_24552 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1939, Current, 0, 1, 30489);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1939, Current, 30489);
	RTCC(arg1, 1939, l_feature_name, 1, RTWCT(15518, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1940_24553 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1939, Current, 0, 0, 30490);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1939, Current, 30490);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1940_24554 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1939, Current, 0, 0, 30491);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1939, Current, 30491);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1940_24555 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1939, Current, 0, 0, 30492);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1939, Current, 30492);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1940_24556 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1939, Current, 0, 2, 30493);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1939, Current, 30493);
	RTCC(arg1, 1939, l_feature_name, 1, eif_new_type(1510, 0x01), 0x01);
	RTCC(arg2, 1939, l_feature_name, 2, eif_new_type(1486, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1940_24557 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_3 ui4_3x.it_i4
	...
	RTEAA(l_feature_name, 1939, Current, 0, 3, 30494);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1939, Current, 30494);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
static EIF_TYPED_VALUE F1940_24558_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1939, Current, 0, 0, 30495);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1939, Current, 30495);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1940_24558 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15518, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1940_24558_body (Current)).it_r;
