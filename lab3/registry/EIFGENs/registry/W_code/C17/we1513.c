...
extern void F1513_17122(EIF_REFERENCE);
extern void F1513_17123(EIF_REFERENCE);
extern void F1513_17124(EIF_REFERENCE);
extern void F1513_17125(EIF_REFERENCE);
...
/* {WEL_SCREEN_DC}.get */
void F1513_17122 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1512, Current, 1, 0, 23808);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1512, Current, 23808);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1513_17123 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1512, Current, 1, 0, 23809);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1512, Current, 23809);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tp1 = *(EIF_POINTER *)(Current + RTWA(12138, dtype));
	if ((EIF_BOOLEAN)(tp1 != loc1)) {
...
void F1513_17124 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1512, Current, 1, 0, 23810);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1512, Current, 23810);
	RTIV(Current, RTAL);
...
void F1513_17125 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1512, Current, 1, 0, 23811);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1512, Current, 23811);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
