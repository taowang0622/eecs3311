...
extern EIF_TYPED_VALUE F972_7192(EIF_REFERENCE);
...
RTOID (F972_7192)
EIF_TYPED_VALUE F972_7192 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 971, Current, 0, 0, 13469);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(971, Current, 13469);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
