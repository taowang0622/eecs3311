...
extern EIF_TYPED_VALUE F2027_1904(EIF_REFERENCE);
extern void F2027_1905(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2027_1906(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2027_1907(EIF_REFERENCE);
extern void F2027_1908(EIF_REFERENCE);
extern void F2027_1909(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2027_1910(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2027_1911(EIF_REFERENCE);
extern void F2027_1912(EIF_REFERENCE);
extern void F2027_7005(EIF_REFERENCE, int);
...
/* {BI_LINKABLE}.left */
EIF_TYPED_VALUE F2027_1904 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F2027_1905 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2026, Current, 2, 1, 19890);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2026, Current, 19890);
	RTCC(arg1, 2026, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(4);
	RTDBGAA(Current, dtype, 1688, 0xF80007EA, 0); /* right */
	RTAR(Current, arg1);
...
void F2027_1906 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2026, Current, 1, 1, 19891);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2026, Current, 19891);
	RTCC(arg1, 2026, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF80007EA, 0, 0); /* loc1 */
	...
	RTHOOK(4);
	RTDBGAA(Current, dtype, 1691, 0xF80007EA, 0); /* left */
	RTAR(Current, arg1);
...
void F2027_1907 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 2026, Current, 2, 0, 19892);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2026, Current, 19892);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
void F2027_1908 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 2026, Current, 2, 0, 19893);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2026, Current, 19893);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
void F2027_1909 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 2026, Current, 1, 1, 19894);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2026, Current, 19894);
	RTCC(arg1, 2026, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF80007EA, 0, 0); /* loc1 */
...
void F2027_1910 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 2026, Current, 1, 1, 19895);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2026, Current, 19895);
	RTCC(arg1, 2026, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF80007EA, 0, 0); /* loc1 */
...
void F2027_1911 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2026, Current, 0, 0, 19896);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(2026, Current, 19896);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 1688, 0xF80007EA, 0); /* right */
...
void F2027_1912 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 2026, Current, 0, 0, 19897);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2026, Current, 19897);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1691, 0xF80007EA, 0); /* left */
	*(EIF_REFERENCE *)(Current + RTWA(1691, dtype)) = (EIF_REFERENCE) NULL;
...
void F2027_7005 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU(SK_REF, &loc1);
	RTLU(SK_REF, &loc2);
	RTEAINV(l_feature_name, 2026, Current, 2, 7004);
	RTSA(dtype);
	RTME(dtype, 0);
