...
extern EIF_TYPED_VALUE F1593_17999(EIF_REFERENCE);
extern void F1593_18000(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1593_17999 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1593_18000 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1592, Current, 0, 0, 24831);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1592, Current, 24831);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14684, 0xF80006AD, 0); /* implementation */
