...
extern EIF_TYPED_VALUE F1029_7815(EIF_REFERENCE);
...
RTOID (F1029_7815)
EIF_TYPED_VALUE F1029_7815 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1028, Current, 0, 0, 14081);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1028, Current, 14081);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
