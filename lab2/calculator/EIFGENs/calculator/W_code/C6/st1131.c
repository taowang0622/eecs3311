...
extern EIF_TYPED_VALUE F1131_8286(EIF_REFERENCE);
extern void F1131_8287(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1131_8288(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1131_8289(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1131_8290(EIF_REFERENCE);
extern void F1131_8291(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1131_8292(EIF_REFERENCE);
extern void F1131_9348(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1131_8286 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {STACK_ARRAY}.make */
void F1131_8287 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1130, Current, 0, 0, 14770);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1130, Current, 14770);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5940, 0xF8000107, 0); /* implementation */
...
/* {STACK_ARRAY}.model */
EIF_TYPED_VALUE F1131_8288 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1130, Current, 2, 0, 14771);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1130, Current, 14771);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {STACK_ARRAY}.count */
EIF_TYPED_VALUE F1131_8289 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1130, Current, 0, 0, 14772);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1130, Current, 14772);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {STACK_ARRAY}.top */
EIF_TYPED_VALUE F1131_8290 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1130, Current, 0, 0, 14773);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1130, Current, 14773);
	RTIV(Current, RTAL);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5389, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(3,1);
		tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5703, "first", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
		if (RTEQ(Result, tr2)) {
			RTCK;
		} else {
			RTCF;
...
/* {STACK_ARRAY}.push */
void F1131_8291 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1130, Current, 0, 1, 14774);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1130, Current, 14774);
	RTCC(arg1, 1130, l_feature_name, 1, RTWCT(5395, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
	...
	if (RTAL & CK_ENSURE) {
		...
		RTCO(tr2);
		ur1 = RTCCL(arg1);
		tr4 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5719, "prepended", (tr1)))((tr1), ur1x)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
		if (RTEQ(tr3, tr4)) {
			RTCK;
		} else {
			RTCF;
...
/* {STACK_ARRAY}.pop */
void F1131_8292 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1130, Current, 0, 0, 14775);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1130, Current, 14775);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT(NULL, EX_PRE);
...
void F1131_9348 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTLU (SK_REF, &Current);
	RTLU(SK_REF, &loc1);
	RTEAINV(l_feature_name, 1130, Current, 1, 9347);
	RTSA(dtype);
	RTME(dtype, 0);
	...
	*(EIF_INTEGER_32 *)tr1 = ((EIF_INTEGER_32) 1L);
	...
	for (;;) {
		...
		ui4_1 = ti4_1;
		tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5707, "item", tr1))(tr1, ui4_1x)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5940, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5390, dtype))(Current)).it_i4);
