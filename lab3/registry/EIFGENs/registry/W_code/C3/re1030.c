...
extern EIF_TYPED_VALUE F1030_9760(EIF_REFERENCE);
extern void F1030_25375(EIF_REFERENCE, int);
...
/* {REGISTRY_ACCESS}.m */
RTOID (F1030_9760)
EIF_TYPED_VALUE F1030_9760 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1029, Current, 0, 0, 16079);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1029, Current, 16079);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F1030_25375 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1029, Current, 0, 25374);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT(NULL, Current);
