...
extern EIF_TYPED_VALUE F1374_14390(EIF_REFERENCE);
...
RTOID (F1374_14390)
EIF_TYPED_VALUE F1374_14390 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1373, Current, 0, 0, 21151);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1373, Current, 21151);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
