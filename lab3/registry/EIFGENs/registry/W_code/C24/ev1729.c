...
extern EIF_TYPED_VALUE F1729_19674(EIF_REFERENCE);
extern void F1729_19679(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1729_19680(EIF_REFERENCE);
static EIF_TYPED_VALUE F1729_19681_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1729_19681(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1729_19674 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1728, Current, 1, 0, 26122);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1728, Current, 26122);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,245,0xFF01,1626,0xFFFF};
		EIF_TYPE typres0;
	...
	for (;;) {
		...
		RTNHOOK(5,2);
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(14976, "is_selected", tr2))(tr2)).it_b);
		if (tb2) {
			RTHOOK(6);
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15574, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			RTNHOOK(6,1);
...
void F1729_19679 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1728, Current, 0, 0, 26123);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1728, Current, 26123);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 16475, 0x04000000, 1); /* default_key_processing_disabled */
	*(EIF_BOOLEAN *)(Current + RTWA(16475, Dtype(Current))) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F1729_19680 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(16475,Dtype(Current)));
	return r;
}


/* {EV_LIST_I}.interface */
static EIF_TYPED_VALUE F1729_19681_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1728, Current, 0, 0, 26125);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1728, Current, 26125);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1729_19681 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15575, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1729_19681_body (Current)).it_r;
