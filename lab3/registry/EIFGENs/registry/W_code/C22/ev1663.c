...
static EIF_TYPED_VALUE F1663_18821_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1663_18821(EIF_REFERENCE);
extern void F1663_25394(EIF_REFERENCE, int);
...
static EIF_TYPED_VALUE F1663_18821_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1662, Current, 0, 0, 25429);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1662, Current, 25429);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1663_18821 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15518, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1663_18821_body (Current)).it_r;
...
void F1663_25394 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1662, Current, 0, 25393);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("not_has_text_implies_text_empty", Current);
	tb1 = '\01';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15733, dtype))(Current)).it_b);
	if ((EIF_BOOLEAN) !tb2) {
