...
extern EIF_TYPED_VALUE F994_7452(EIF_REFERENCE);
...
RTOID (F994_7452)
EIF_TYPED_VALUE F994_7452 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 993, Current, 0, 0, 13712);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(993, Current, 13712);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
