...
extern EIF_TYPED_VALUE F971_7255(EIF_REFERENCE);
...
EIF_TYPED_VALUE F971_7255 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 970, Current, 0, 0, 13526);
	RTSA(Dtype(Current));
	RTSC;
	...
	RTNHOOK(1,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4955, "time_default_format_string", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
