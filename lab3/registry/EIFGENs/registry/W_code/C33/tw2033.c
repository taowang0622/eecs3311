...
extern EIF_TYPED_VALUE F2033_3137(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2033_3138(EIF_REFERENCE);
extern void F2033_3139(EIF_REFERENCE);
extern void F2033_3140(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2033_3141(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2033_3142(EIF_REFERENCE);
...
EIF_TYPED_VALUE F2033_3137 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 2032, Current, 1, 0, 20293);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2032, Current, 20293);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F2033_3138 (EIF_REFERENCE Current)
{
	GTCX
...
void F2033_3139 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 2032, Current, 1, 0, 20295);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(2579, dtype)) = (EIF_INTEGER_32) ti4_1;
	...
	if (tb1) {
		RTHOOK(9);
		RTDBGAA(Current, dtype, 2580, 0xF80007EA, 0); /* active */
...
void F2033_3140 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 2032, Current, 3, 0, 20296);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2032, Current, 20296);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("valid_position", EX_PRE);
...
EIF_TYPED_VALUE F2033_3141 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F2033_3142 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
