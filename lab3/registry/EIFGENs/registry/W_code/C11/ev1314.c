...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1313, Current, 2, 2, 20403);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1313, Current, 20403);
	if (arg1) {
		RTCC(arg1, 1313, l_feature_name, 1, eif_new_type(1408, 0x00), 0x00);
	}
	if (arg2) {
		RTCC(arg2, 1313, l_feature_name, 2, eif_new_type(1776, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	if (
	...
	loc1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(11603, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTHOOK(4);
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(14559, "set_values", loc1))(loc1, ur1x, ur2x);
	RTHOOK(5);
	ur1 = RTCCL(loc1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1313, Current, 0, 0, 20404);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1313, Current, 20404);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	ur1 = NULL;
	ur2 = NULL;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(14554, Dtype(tr1)))(tr1, ur1x, ur2x);
	RTNHOOK(1,1);
	Result = (EIF_REFERENCE) RTCCL(tr1);
	RTVI(Current, RTAL);
	RTRS;
