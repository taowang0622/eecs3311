...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1189, Current, 0, 0, 18344);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1189, Current, 18344);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000748, 0,0); /* Result */
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9902, Dtype(Current)))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(1,1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1189, Current, 0, 0, 18346);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1189, Current, 18346);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000146, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,326,0xFF01,1864,0xFFFF};
		EIF_TYPE typres0;
	...
	tr2 = RTLN(eif_new_type(1864, 0x01).id);
	tr3 = RTMS_EX_H("WEL Silly Window",16,787402615);
	ur1 = tr3;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(18651, Dtype(tr2)))(tr2, ur1x);
	RTNHOOK(1,1);
	ur1 = RTCCL(tr2);
