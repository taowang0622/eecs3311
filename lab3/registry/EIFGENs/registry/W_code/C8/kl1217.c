...
extern EIF_TYPED_VALUE F1217_12677(EIF_REFERENCE);
...
RTOID (F1217_12677)
EIF_TYPED_VALUE F1217_12677 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1216, Current, 0, 0, 18901);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1216, Current, 18901);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
