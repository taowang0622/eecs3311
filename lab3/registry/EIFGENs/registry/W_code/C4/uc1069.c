...
extern EIF_TYPED_VALUE F1069_10257(EIF_REFERENCE);
...
RTOID (F1069_10257)
EIF_TYPED_VALUE F1069_10257 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1068, Current, 0, 0, 16573);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1068, Current, 16573);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
