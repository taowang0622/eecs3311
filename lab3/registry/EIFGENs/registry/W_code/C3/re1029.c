...
extern void F1029_25375(EIF_REFERENCE, int);
...
void F1029_25375 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1028, Current, 0, 25374);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT(NULL, Current);
