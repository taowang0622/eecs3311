...
static const EIF_TYPE_INDEX egt_13_963 [] = {0xFF01,1115,0xFF01,231,0xFFFF};
static const EIF_TYPE_INDEX egt_14_963 [] = {0xFF01,1126,190,0xFFFF};
...
static const struct desc_info desc_963[] = {
	...
	{EIF_NON_GENERIC(0x017D /*190*/), 13446, 0xFFFFFFFF},
};
void Init963(void)
{
	IDSC(desc_963, 0, 962);
	IDSC(desc_963 + 1, 1, 962);
	IDSC(desc_963 + 32, 358, 962);
}
