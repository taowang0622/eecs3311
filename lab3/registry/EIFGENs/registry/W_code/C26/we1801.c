...
extern EIF_TYPED_VALUE F1801_20583(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1801_20583 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1800, Current, 0, 0, 26783);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1800, Current, 26783);
	RTIV(Current, RTAL);
	RTHOOK(1);
