...
extern EIF_TYPED_VALUE F1179_11913(EIF_REFERENCE);
...
RTOID (F1179_11913)
EIF_TYPED_VALUE F1179_11913 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1178, Current, 0, 0, 18187);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1178, Current, 18187);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
