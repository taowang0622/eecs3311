...
static const struct desc_info desc_960[] = {
	...
	{EIF_NON_GENERIC(0x01A7 /*211*/), 13379, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A7 /*211*/), 13380, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A7 /*211*/), 13381, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A7 /*211*/), 13382, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A7 /*211*/), 13383, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A7 /*211*/), 13384, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A7 /*211*/), 13385, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A7 /*211*/), 13386, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A7 /*211*/), 13387, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A7 /*211*/), 13388, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A7 /*211*/), 13389, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A7 /*211*/), 13390, 0xFFFFFFFF},
};
void Init960(void)
{
	IDSC(desc_960, 0, 959);
	IDSC(desc_960 + 1, 1, 959);
	IDSC(desc_960 + 32, 1345, 959);
}
