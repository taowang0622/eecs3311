...
extern void F2038_3743(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2038_3744(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2038_3745(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2038_3746(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2038_3747(EIF_REFERENCE);
...
void F2038_3743 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2037, Current, 0, 1, 31306);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2037, Current, 31306);
	RTCC(arg1, 2037, l_feature_name, 1, RTWCT(1747, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F2038_3744 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2037, Current, 0, 1, 31307);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2037, Current, 31307);
	RTCC(arg1, 2037, l_feature_name, 1, RTWCT(1747, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F2038_3745 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2037, Current, 6, 0, 31308);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2037, Current, 31308);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F2038_3746 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2037, Current, 2, 0, 31309);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2037, Current, 31309);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F2038_3747 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2037, Current, 0, 0, 31310);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2037, Current, 31310);
	RTIV(Current, RTAL);
	RTHOOK(1);
