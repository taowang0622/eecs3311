...
static const EIF_TYPE_INDEX egt_13_1024 [] = {0xFF01,270,0xFF01,231,0xFFFF};
...
static const struct desc_info desc_1024[] = {
	...
	{EIF_GENERIC(egt_13_1024), 14029, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1024), 0x00, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 14030, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x017D /*190*/), 14031, 0},
};
void Init1024(void)
{
	IDSC(desc_1024, 0, 1023);
	IDSC(desc_1024 + 1, 1, 1023);
	IDSC(desc_1024 + 32, 102, 1023);
	IDSC(desc_1024 + 34, 387, 1023);
}
