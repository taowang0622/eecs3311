...
extern EIF_TYPED_VALUE F1797_20534(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1797_20535(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1797_20534 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1796, Current, 0, 0, 26640);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1796, Current, 26640);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1797_20535 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1796, Current, 0, 0, 26641);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1796, Current, 26641);
	RTIV(Current, RTAL);
	RTHOOK(1);
