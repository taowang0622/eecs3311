...
extern void F971_8744(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F971_8744 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 970, Current, 0, 1, 15017);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6580, 0xF80000F5, 0); /* parameters */
	tr1 = RTLNSMART(RTWCT(6580, dtype, Dftype(Current)).id);
	ui4_1 = arg1;
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 970, Current, 2, 0, 15019);
	RTSA(Dtype(Current));
	RTSC;
	...
	loc1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6580, Dtype(Current)))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTHOOK(2);
