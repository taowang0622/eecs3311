...
extern EIF_TYPED_VALUE F975_7198(EIF_REFERENCE);
...
RTOID (F975_7198)
EIF_TYPED_VALUE F975_7198 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 974, Current, 0, 0, 13471);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(974, Current, 13471);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
