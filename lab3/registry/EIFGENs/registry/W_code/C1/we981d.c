...
static const struct desc_info desc_981[] = {
	...
	{EIF_NON_GENERIC(0x01B3 /*217*/), 15088, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 15089, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 15090, 0xFFFFFFFF},
};
void Init981(void)
{
	IDSC(desc_981, 0, 980);
	IDSC(desc_981 + 1, 1, 980);
	IDSC(desc_981 + 32, 1176, 980);
}
