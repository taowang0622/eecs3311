...
extern void F1910_23350(EIF_REFERENCE);
extern void F1910_23351(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1910_23352(EIF_REFERENCE);
static EIF_TYPED_VALUE F1910_23353_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1910_23353(EIF_REFERENCE);
extern void F1910_23354(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1910_23350 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1909, Current, 1, 0, 29450);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1909, Current, 29450);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 19241, 0x04000000, 1); /* is_selected */
	*(EIF_BOOLEAN *)(Current + RTWA(19241, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	...
	if (EIF_TEST(loc1)) {
		...
		ui4_1 = ti4_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(18742, "check_button", loc1))(loc1, ui4_1x);
	}
	RTHOOK(5);
...
void F1910_23351 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1909, Current, 1, 0, 29451);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1909, Current, 29451);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_selectable", EX_PRE);
...
body:;
	...
	*(EIF_BOOLEAN *)(Current + RTWA(19241, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	...
	if (EIF_TEST(loc1)) {
		...
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(10693, dtype));
		ui4_1 = ti4_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(18743, "uncheck_button", loc1))(loc1, ui4_1x);
	}
	RTHOOK(5);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9553, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	if ((EIF_BOOLEAN)(tr1 != NULL)) {
...
EIF_TYPED_VALUE F1910_23352 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
static EIF_TYPED_VALUE F1910_23353_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1909, Current, 0, 0, 29453);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1909, Current, 29453);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1910_23353 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15575, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1910_23353_body (Current)).it_r;
...
void F1910_23354 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_b
	...
	RTEAA(l_feature_name, 1909, Current, 0, 1, 29454);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1909, Current, 29454);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 19241, 0x04000000, 1); /* is_selected */
	*(EIF_BOOLEAN *)(Current + RTWA(19241, Dtype(Current))) = (EIF_BOOLEAN) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
