...
extern EIF_TYPED_VALUE F1042_8044(EIF_REFERENCE);
...
RTOID (F1042_8044)
EIF_TYPED_VALUE F1042_8044 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1041, Current, 0, 0, 14491);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1041, Current, 14491);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
