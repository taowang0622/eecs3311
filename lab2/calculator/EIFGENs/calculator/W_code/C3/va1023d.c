...
static const EIF_TYPE_INDEX egt_13_1023 [] = {0xFF01,270,0xFF01,231,0xFFFF};
...
static const struct desc_info desc_1023[] = {
	...
	{EIF_GENERIC(egt_13_1023), 14019, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1023), 0x00, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 14020, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x017D /*190*/), 14021, 0},
};
void Init1023(void)
{
	IDSC(desc_1023, 0, 1022);
	IDSC(desc_1023 + 1, 1, 1022);
	IDSC(desc_1023 + 32, 102, 1022);
	IDSC(desc_1023 + 34, 381, 1022);
}
