...
extern EIF_TYPED_VALUE F1049_8210(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1049_8212(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1049_8210 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1048, Current, 2, 3, 14681);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1048, Current, 14681);
...
EIF_TYPED_VALUE F1049_8212 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_c1
	...
	RTEAA(l_feature_name, 1048, Current, 0, 1, 14682);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1048, Current, 14682);
	RTIV(Current, RTAL);
	RTHOOK(1);
