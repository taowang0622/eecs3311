...
extern void F2024_1965(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F2024_1966(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F2024_7007(EIF_REFERENCE, int);
...
void F2024_1965 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2023, Current, 2, 1, 19938);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2023, Current, 19938);
	RTCC(arg1, 2023, l_feature_name, 1, RTWCT(1706, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F2024_1966 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define arg2 arg2x.it_r
	...
	RTEAA(l_feature_name, 2023, Current, 1, 2, 19939);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2023, Current, 19939);
	RTCC(arg1, 2023, l_feature_name, 1, RTWCT(1706, dtype, dftype), 0x00);
	{
...
void F2024_7007 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 2023, Current, 0, 7006);
	RTSA(dtype);
	RTME(dtype, 0);
