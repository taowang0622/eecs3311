...
extern EIF_TYPED_VALUE F1031_7817(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1031_7817 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1030, Current, 0, 2, 14083);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1030, Current, 14083);
	if (arg1) {
		RTCC(arg1, 1030, l_feature_name, 1, eif_new_type(231, 0x00), 0x00);
	}
	if (arg2) {
		RTCC(arg2, 1030, l_feature_name, 2, eif_new_type(231, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	if (RTCEQ(arg1, arg2)) {
