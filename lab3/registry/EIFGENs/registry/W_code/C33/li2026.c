...
extern void F2026_3634(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2026_3635(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2026_3636(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {LINKED_SET}.put */
void F2026_3634 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2025, Current, 0, 1, 20313);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2025, Current, 20313);
	RTCC(arg1, 2025, l_feature_name, 1, RTWCT(1706, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
/* {LINKED_SET}.extend */
void F2026_3635 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2025, Current, 0, 1, 20314);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2025, Current, 20314);
	RTCC(arg1, 2025, l_feature_name, 1, RTWCT(1706, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {LINKED_SET}.prune */
void F2026_3636 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2025, Current, 0, 1, 20315);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2025, Current, 20315);
	RTCC(arg1, 2025, l_feature_name, 1, RTWCT(1725, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
