...
extern EIF_TYPED_VALUE F1607_18182(EIF_REFERENCE);
extern void F1607_18183(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1607_18182 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1607_18183 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1606, Current, 0, 0, 24920);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1606, Current, 24920);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14627, 0xF80006B9, 0); /* implementation */
