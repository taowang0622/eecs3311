...
static const EIF_TYPE_INDEX egt_13_963 [] = {0xFF01,170,0xFFFF};
...
static const struct desc_info desc_963[] = {
	...
	{EIF_NON_GENERIC(0x01C5 /*226*/), 13414, 0xFFFFFFFF},
	{EIF_GENERIC(egt_13_963), 13415, 0},
