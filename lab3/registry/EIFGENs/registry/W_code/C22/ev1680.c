...
static EIF_TYPED_VALUE F1680_19165_body(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1680_19165_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1679, Current, 0, 0, 25805);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1679, Current, 25805);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1680_19165 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15575, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1680_19165_body (Current)).it_r;
