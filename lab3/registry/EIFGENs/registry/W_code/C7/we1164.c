...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1163, Current, 0, 0, 17974);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1163, Current, 17974);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1163, Current, 0, 0, 17975);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1163, Current, 17975);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000146, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,326,1860,0xFFFF};
		EIF_TYPE typres0;
