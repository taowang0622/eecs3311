...
extern EIF_TYPED_VALUE F1630_18419(EIF_REFERENCE);
extern void F1630_18420(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1630_18419 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1630_18420 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1629, Current, 0, 0, 25252);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1629, Current, 25252);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14684, 0xF80006D0, 0); /* implementation */
