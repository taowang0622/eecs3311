...
extern EIF_TYPED_VALUE F1589_17944(EIF_REFERENCE);
extern void F1589_17945(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1589_17944 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1589_17945 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1588, Current, 0, 0, 24682);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1588, Current, 24682);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14627, 0xF80006A9, 0); /* implementation */
