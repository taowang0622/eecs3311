...
extern EIF_TYPED_VALUE F1018_7759(EIF_REFERENCE);
...
RTOID (F1018_7759)
EIF_TYPED_VALUE F1018_7759 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1017, Current, 0, 0, 13979);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1017, Current, 13979);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
