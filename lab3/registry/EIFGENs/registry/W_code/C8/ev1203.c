...
extern void F1203_12462(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1203_12463(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1203_12464(EIF_REFERENCE);
extern void F1203_12465(EIF_REFERENCE);
extern void F1203_12466(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1203_12459 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(10271,Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F1203_12460 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(10272,Dtype(Current)));
	return r;
}


/* {EV_GRAPHICAL_FORMAT}.set_scale_width */
void F1203_12462 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1202, Current, 0, 1, 18701);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10270, 0x10000000, 1); /* scale_width */
	*(EIF_INTEGER_32 *)(Current + RTWA(10270, dtype)) = (EIF_INTEGER_32) arg1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
void F1203_12463 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1202, Current, 0, 1, 18702);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10271, 0x10000000, 1); /* scale_height */
	*(EIF_INTEGER_32 *)(Current + RTWA(10271, dtype)) = (EIF_INTEGER_32) arg1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
		RTCT("scale_height_set", EX_POST);
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(10271, dtype));
		if ((EIF_BOOLEAN)(ti4_1 == arg1)) {
			RTCK;
		} else {
			RTCF;
...
void F1203_12464 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1202, Current, 0, 0, 18703);
	RTSA(Dtype(Current));
	RTSC;
...
void F1203_12465 (EIF_REFERENCE Current)
{
	GTCX
...
void F1203_12466 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1202, Current, 0, 0, 18705);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1202, Current, 18705);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
