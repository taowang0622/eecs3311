...
extern EIF_TYPED_VALUE F1031_7823(EIF_REFERENCE);
...
RTOID (F1031_7823)
EIF_TYPED_VALUE F1031_7823 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1030, Current, 0, 0, 14092);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1030, Current, 14092);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
