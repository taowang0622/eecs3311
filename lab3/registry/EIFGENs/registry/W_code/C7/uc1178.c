...
extern EIF_TYPED_VALUE F1178_11912(EIF_REFERENCE);
...
RTOID (F1178_11912)
EIF_TYPED_VALUE F1178_11912 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1177, Current, 0, 0, 18186);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1177, Current, 18186);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
