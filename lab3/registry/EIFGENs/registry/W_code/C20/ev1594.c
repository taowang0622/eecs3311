...
extern EIF_TYPED_VALUE F1594_18001(EIF_REFERENCE);
extern void F1594_18002(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1594_18001 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1594_18002 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1593, Current, 0, 0, 24833);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1593, Current, 24833);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14684, 0xF80006AE, 0); /* implementation */
