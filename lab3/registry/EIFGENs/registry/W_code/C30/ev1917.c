...
extern EIF_TYPED_VALUE F1917_23843(EIF_REFERENCE);
extern void F1917_23844(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1917_23845(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1917_23846(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1917_23847(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1917_23848(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1917_23849(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1917_23850(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1917_23851(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1917_23852(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1917_23853_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1917_23853(EIF_REFERENCE);
extern void EIF_Minit1917(void);
extern EIF_REFERENCE _A1917_1816();
...
EIF_TYPED_VALUE F1917_23843 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(19447,Dtype(Current)));
	return r;
}


/* {EV_VERTICAL_BOX_IMP}.set_homogeneous */
void F1917_23844 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1916, Current, 0, 1, 29790);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1916, Current, 29790);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 19446, 0x04000000, 1); /* is_homogeneous */
	*(EIF_BOOLEAN *)(Current + RTWA(19446, dtype)) = (EIF_BOOLEAN) arg1;
	RTHOOK(2);
...
void F1917_23845 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1916, Current, 0, 1, 29791);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1916, Current, 29791);
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(19445, dtype)) = (EIF_INTEGER_32) arg1;
	RTHOOK(3);
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15958, dtype))(Current)).it_i4);
	ui4_1 = ti4_1;
	ur1 = RTCCL(Current);
...
void F1917_23846 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1916, Current, 0, 1, 29792);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1916, Current, 29792);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("positive_value", EX_PRE);
...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(19444, dtype)) = (EIF_INTEGER_32) arg1;
	RTHOOK(3);
	...
	if (RTAL & CK_ENSURE) {
		...
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(19444, dtype));
...
void F1917_23847 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1916, Current, 0, 3, 29793);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1916, Current, 29793);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
body:;
	RTHOOK(3);
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16212, dtype))(Current)).it_i4);
	ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(19444, dtype));
	ui4_1 = (EIF_INTEGER_32) (ti4_1 + (EIF_INTEGER_32) (((EIF_INTEGER_32) 2L) * ti4_2));
	ub1 = (EIF_BOOLEAN) 1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(19448, dtype))(Current, ui4_1x, ub1x);
	RTHOOK(4);
	ui4_1 = arg1;
	ui4_2 = arg2;
	ui4_3 = arg3;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(18369, 1915))(Current, ui4_1x, ui4_2x, ui4_3x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTDBGLE;
...
void F1917_23848 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x, EIF_TYPED_VALUE arg5x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1916, Current, 0, 5, 29794);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1916, Current, 29794);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1917_23849 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1916, Current, 16, 2, 29795);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1916, Current, 29795);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(ti4_1 != ((EIF_INTEGER_32) 0L))) {
		...
		loc9 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16211, dtype))(Current)).it_i4);
		RTHOOK(6);
		RTDBGAL(Current, 10, 0x10000000, 1, 0); /* loc10 */
		loc10 = *(EIF_INTEGER_32 *)(Current + RTWA(19444, dtype));
		RTHOOK(7);
		RTDBGAL(Current, 11, 0x10000000, 1, 0); /* loc11 */
		loc11 = *(EIF_INTEGER_32 *)(Current + RTWA(19445, dtype));
		RTHOOK(8);
		RTDBGAL(Current, 7, 0x10000000, 1, 0); /* loc7 */
		loc7 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(19431, dtype))(Current)).it_i4);
		loc7 = (EIF_INTEGER_32) (EIF_INTEGER_32) ((EIF_INTEGER_32) (arg1 - (EIF_INTEGER_32) (((EIF_INTEGER_32) 2L) * loc10)) - loc7);
		RTHOOK(9);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(18630, dtype))(Current)).it_b);
		if (tb1) {
			RTHOOK(10);
			RTDBGAL(Current, 16, 0xF80000F5, 0, 0); /* loc16 */
			loc16 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(19441, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			RTHOOK(11);
			if ((EIF_BOOLEAN)(loc16 == NULL)) {
				RTHOOK(12);
				RTDBGAL(Current, 16, 0xF80000F5, 0, 0); /* loc16 */
				tr1 = RTLNSMART(RTWCT(19441, dtype, dftype).id);
				...
				RTHOOK(13);
				RTDBGAA(Current, dtype, 19441, 0xF80000F5, 0); /* reversed_sizing_agents */
				RTAR(Current, loc16);
				*(EIF_REFERENCE *)(Current + RTWA(19441, dtype)) = (EIF_REFERENCE) RTCCL(loc16);
			} else {
				RTHOOK(14);
		...
		if (tb1) {
			...
			loc4 = *(EIF_INTEGER_32 *)(Current + RTWA(19432, dtype));
			loc4 = (EIF_INTEGER_32) (EIF_INTEGER_32) (loc7 / loc4);
			RTHOOK(18);
			RTDBGAL(Current, 5, 0x10000000, 1, 0); /* loc5 */
			loc5 = *(EIF_INTEGER_32 *)(Current + RTWA(19432, dtype));
			...
			for (;;) {
				...
				if (tb2) {
					...
					ui4_1 = loc5;
					loc8 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(19439, dtype))(Current, ui4_1x)).it_i4);
					...
					if ((EIF_BOOLEAN)(loc16 != NULL)) {
						RTHOOK(27);
						{
							EIF_TYPE_INDEX typarr0[] = {0xFFF9,7,185,0xFF01,0,0xFF01,1911,217,217,217,217,202,0xFFFF};
							EIF_TYPE typres0;
							typarr0[4] = dftype;
						...
						
						{
							...
							tr2 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1917_1816, (EIF_POINTER)(0),19442, 0, 0, 1, -1, tr1, 0);
						}
						ur1 = RTCCL(tr2);
						...
						ui4_4 = loc8;
						ub1 = arg2;
						(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(19442, dtype))(Current, ur1x, ui4_1x, ui4_2x, ui4_3x, ui4_4x, ub1x);
					}
					RTHOOK(29);
					RTDBGAL(Current, 6, 0x10000000, 1, 0); /* loc6 */
			...
			loc13 = *(EIF_INTEGER_32 *)(Current + RTWA(19447, dtype));
			loc13 = (EIF_INTEGER_32) (EIF_INTEGER_32) (loc7 - loc13);
			RTHOOK(33);
			RTDBGAL(Current, 14, 0x10000000, 1, 0); /* loc14 */
			ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(19434, dtype));
			...
			for (;;) {
				...
				loc3 = (EIF_REFERENCE) RTCCL(tr1);
				RTHOOK(49);
				tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(16188, "is_show_requested", loc3))(loc3)).it_b);
				if (tb3) {
					RTHOOK(50);
...
void F1917_23850 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1916, Current, 5, 1, 29796);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1916, Current, 29796);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_is_destroyed", EX_PRE);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 19432, 0x10000000, 1); /* childvisible_nb */
	*(EIF_INTEGER_32 *)(Current + RTWA(19432, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	RTHOOK(3);
	...
	RTHOOK(15);
	RTDBGAA(Current, dtype, 19432, 0x10000000, 1); /* childvisible_nb */
	*(EIF_INTEGER_32 *)(Current + RTWA(19432, dtype)) = (EIF_INTEGER_32) loc5;
	RTHOOK(16);
...
void F1917_23851 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1916, Current, 5, 1, 29797);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1916, Current, 29797);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_is_destroyed", EX_PRE);
	...
	if ((EIF_BOOLEAN) !tb1) {
		...
		if (tb1) {
			...
			*(EIF_INTEGER_32 *)(Current + RTWA(19432, dtype)) = (EIF_INTEGER_32) loc5;
			...
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(19433, dtype))(Current);
			RTHOOK(16);
			ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(19431, dtype))(Current)).it_i4);
			ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(19444, dtype));
			...
			for (;;) {
				...
				loc2 = (EIF_REFERENCE) RTCCL(tr1);
				RTHOOK(20);
				tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(16188, "is_show_requested", loc2))(loc2)).it_b);
				if (tb3) {
					RTHOOK(21);
					RTDBGAL(Current, 4, 0x10000000, 1, 0); /* loc4 */
					ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(16030, "minimum_height", loc2))(loc2)).it_i4);
			...
			RTHOOK(24);
			RTDBGAA(Current, dtype, 19447, 0x10000000, 1); /* children_height */
			*(EIF_INTEGER_32 *)(Current + RTWA(19447, dtype)) = (EIF_INTEGER_32) loc4;
			RTHOOK(25);
			RTDBGAA(Current, dtype, 19432, 0x10000000, 1); /* childvisible_nb */
			*(EIF_INTEGER_32 *)(Current + RTWA(19432, dtype)) = (EIF_INTEGER_32) loc5;
			RTHOOK(26);
		...
		RTHOOK(30);
		RTDBGAA(Current, dtype, 19447, 0x10000000, 1); /* children_height */
		*(EIF_INTEGER_32 *)(Current + RTWA(19447, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
		RTHOOK(31);
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(19444, dtype));
...
void F1917_23852 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1916, Current, 6, 1, 29798);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1916, Current, 29798);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_is_destroyed", EX_PRE);
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(19432, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	...
	if ((EIF_BOOLEAN) !tb1) {
		...
		if (tb1) {
			...
			RTHOOK(15);
			RTDBGAA(Current, dtype, 19432, 0x10000000, 1); /* childvisible_nb */
			*(EIF_INTEGER_32 *)(Current + RTWA(19432, dtype)) = (EIF_INTEGER_32) loc6;
			RTHOOK(16);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(19433, dtype))(Current);
			RTHOOK(17);
			ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(19444, dtype));
			ui4_1 = (EIF_INTEGER_32) (loc5 + (EIF_INTEGER_32) (((EIF_INTEGER_32) 2L) * ti4_1));
			ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(19431, dtype))(Current)).it_i4);
			ti4_3 = *(EIF_INTEGER_32 *)(Current + RTWA(19444, dtype));
...
static EIF_TYPED_VALUE F1917_23853_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1916, Current, 0, 0, 29799);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1916, Current, 29799);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1917_23853 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15518, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1917_23853_body (Current)).it_r;
