...
extern EIF_TYPED_VALUE F1111_3131(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1111_3132(EIF_REFERENCE);
extern void F1111_3133(EIF_REFERENCE);
extern void F1111_3134(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1111_3135(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1111_3136(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1111_3131 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1110, Current, 1, 0, 14013);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1110, Current, 14013);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1111_3132 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1110, Current, 0, 0, 14014);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1110, Current, 14014);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(2575, dtype));
	if (tb1) {
...
void F1111_3133 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1110, Current, 0, 0, 14015);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1110, Current, 14015);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(3);
		RTDBGAA(Current, dtype, 2580, 0xF8000454, 0); /* active */
...
void F1111_3134 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1110, Current, 2, 0, 14016);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1110, Current, 14016);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("valid_position", EX_PRE);
...
EIF_TYPED_VALUE F1111_3135 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1111_3136 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
