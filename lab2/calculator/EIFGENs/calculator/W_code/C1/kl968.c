...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 967, Current, 0, 0, 13462);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(967, Current, 13462);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	tr2 = RTMS_EX_H("",0,0);
	ur1 = tr2;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(5915, Dtype(tr1)))(tr1, ur1x);
	RTNHOOK(1,1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 967, Current, 0, 0, 13463);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(967, Current, 13463);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	ur1 = tr2;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(5569, Dtype(tr1)))(tr1, ur1x);
	RTNHOOK(1,1);
	Result = (EIF_REFERENCE) RTCCL(tr1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
{
	GTCX
	RTOTS (7169,F968_7169)
	RTOTS (7170,F968_7170)
}
