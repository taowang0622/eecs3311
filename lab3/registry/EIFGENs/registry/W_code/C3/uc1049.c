...
extern EIF_TYPED_VALUE F1049_9961(EIF_REFERENCE);
...
RTOID (F1049_9961)
EIF_TYPED_VALUE F1049_9961 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1048, Current, 0, 0, 16277);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1048, Current, 16277);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
