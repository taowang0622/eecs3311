...
extern EIF_TYPED_VALUE F994_7462(EIF_REFERENCE);
...
RTOID (F994_7462)
EIF_TYPED_VALUE F994_7462 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 993, Current, 0, 0, 13706);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(993, Current, 13706);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
