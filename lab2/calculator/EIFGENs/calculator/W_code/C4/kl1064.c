...
extern EIF_TYPED_VALUE F1064_8371(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1064_8371 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1063, Current, 0, 0, 14855);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1063, Current, 14855);
	RTIV(Current, RTAL);
	RTHOOK(1);
