...
extern EIF_TYPED_VALUE F1065_8378(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1065_8378 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1064, Current, 0, 0, 14990);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1064, Current, 14990);
	RTIV(Current, RTAL);
	RTHOOK(1);
