...
extern EIF_TYPED_VALUE F1181_11937(EIF_REFERENCE);
...
RTOID (F1181_11937)
EIF_TYPED_VALUE F1181_11937 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1180, Current, 0, 0, 18211);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1180, Current, 18211);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
