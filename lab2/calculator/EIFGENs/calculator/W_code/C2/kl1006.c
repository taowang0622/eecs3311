...
extern EIF_TYPED_VALUE F1006_7579(EIF_REFERENCE);
...
RTOID (F1006_7579)
EIF_TYPED_VALUE F1006_7579 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1005, Current, 0, 0, 13804);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1005, Current, 13804);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
