...
extern EIF_TYPED_VALUE F1433_15200(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1433_15201(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1433_15202(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1432, Current, 0, 1, 21969);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1432, Current, 21969);
	RTCC(arg1, 1432, l_feature_name, 1, eif_new_type(1849, 0x01), 0x01);
	RTIV(Current, RTAL);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1432, Current, 0, 0, 21970);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1432, Current, 21970);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
body:;
	...
	up1 = tp1;
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(12674, dtype))(Current, up1x)).it_p);
	up1 = tp1;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1432, Current, 0, 0, 21971);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1432, Current, 21971);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
body:;
	...
	tp1 = *(EIF_POINTER *)(Current + RTWA(12195, dtype));
	up1 = tp1;
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(12675, dtype))(Current, up1x)).it_i4);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
RTOID (F1433_15200)
EIF_TYPED_VALUE F1433_15200 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1433_15200);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1432, Current, 0, 0, 21972);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1432, Current, 21972);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(12673, dtype))(Current)).it_i4);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
EIF_TYPED_VALUE F1433_15201 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1432, Current, 0, 0, 21973);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(1432, Current, 21973);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1433_15202 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 1432, Current, 0, 1, 21974);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(1432, Current, 21974);
	RTIV(Current, RTAL);
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 1432, Current, 0, 1, 21975);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(1432, Current, 21975);
	RTIV(Current, RTAL);
