...
extern EIF_TYPED_VALUE F1339_14103(EIF_REFERENCE);
...
RTOID (F1339_14103)
EIF_TYPED_VALUE F1339_14103 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1338, Current, 0, 0, 20727);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1338, Current, 20727);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
