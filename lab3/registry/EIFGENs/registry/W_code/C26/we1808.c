...
extern EIF_TYPED_VALUE F1808_20633(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1808_20634(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1808_20633 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1807, Current, 0, 0, 26833);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1807, Current, 26833);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1808_20634 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1807, Current, 0, 0, 26834);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1807, Current, 26834);
	RTIV(Current, RTAL);
	RTHOOK(1);
