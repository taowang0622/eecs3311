...
extern EIF_TYPED_VALUE F1611_18237(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1611_18238(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1611_18237 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1611_18238 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1610, Current, 0, 0, 25069);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1610, Current, 25069);
	RTIV(Current, RTAL);
	RTHOOK(1);
