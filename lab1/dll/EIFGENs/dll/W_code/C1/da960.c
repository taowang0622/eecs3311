...
{
	GTCX
	RTOTC (F960_7121,13397,RTMS_EX_H("English",7,257590376));
}
...
{
	GTCX
	RTOTC (F960_7126,13402,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F960_7127,13403,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F960_7128,13404,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
...
void EIF_Minit960 (void)
{
	...
	RTOTS (7125,F960_7125)
	RTOTS (7126,F960_7126)
	RTOTS (7127,F960_7127)
	RTOTS (7128,F960_7128)
}
